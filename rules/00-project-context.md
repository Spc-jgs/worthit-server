...
WorthIt Server 是《值不值》小程序的后端工程。当前按 Phase 0 和 M1 范围逐步搭建，先建立可靠的工程与契约基线，再实现最小业务闭环。

- 不因目录、接口或扩展点已在终稿中出现，就提前实现 M2、M3。
...
- 任务从 Phase 0/M1 扩大到 M2/M3 或公开试用版本迁移；
