...
class RuntimeConfigurationContractTest {
    ...
    void declaresStableRuntimeContractWithoutCommittedSecrets() throws IOException {
        ...
        assertThat(base.getProperty("spring.application.name")).isEqualTo("worthit-reminder");
        assertThat(base.getProperty("server.port")).isEqualTo(18083);
