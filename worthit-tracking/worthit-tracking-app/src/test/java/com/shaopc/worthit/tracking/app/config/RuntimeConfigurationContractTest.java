...
class RuntimeConfigurationContractTest {
    ...
    void declaresStableRuntimeContractWithoutCommittedSecrets() throws IOException {
        ...
        assertThat(base.getProperty("spring.application.name")).isEqualTo("worthit-tracking");
        assertThat(base.getProperty("server.port")).isEqualTo(18082);
